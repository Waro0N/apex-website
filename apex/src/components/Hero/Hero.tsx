        ...
        >
          ...
          <div className="carousel-inner" role="listbox">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://static.vecteezy.com/system/resources/thumbnails/002/016/989/original/the-interior-of-a-large-office-free-video.jpg)",
              }}
            >
              <div className="carousel-container">
                <div className="carousel-content">
                  ...
                  <p className="animate__animated animate__fadeInUp asus">
                    {" "}
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://i.etsystatic.com/36627193/r/il/76cc50/5211422933/il_fullxfull.5211422933_tkpt.jpg)",
              }}
            >
              <div className="carousel-container">
                <div className="carousel-content">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://m.media-amazon.com/images/I/71qrnoTb8qL.jpg)",
              }}
            >
              <div className="carousel-container">
                <div className="carousel-content">
